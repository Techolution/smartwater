...
public class MeterOffDataSimulator extends InsertSeriesData implements IStubData {

	Logger log=Logger.getLogger(MeterOffDataSimulator.class.getName());
	@Override
	public void startProcess(int meterId, String startTime, String endTime, long sleepTime, int incrementtime) {
		...
		while(startDate.before( endDate)){
			...
			try {
				...
				this.sendData("meteroff", startDate, tagList, valuelist);
