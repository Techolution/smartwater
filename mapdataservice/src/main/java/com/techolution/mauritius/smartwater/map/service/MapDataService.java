...
public class MapDataService {
	...
	public List<MeterConsumption> getDataForAllConnections(RequestData data) throws ParseException{
		...
		ResponseEntity<MeterConnection[]> responseEntity = restTemplate().getForEntity("https://smartwatergke.techolution.com/consolidateddata/connections",MeterConnection[].class);
