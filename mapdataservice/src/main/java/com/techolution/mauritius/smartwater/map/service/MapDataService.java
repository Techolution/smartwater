...
public class MapDataService {
	...
	public List<MeterConsumption> getDataForAllConnections(RequestData data) throws ParseException{
		...
		ResponseEntity<MeterConnection[]> responseEntity = restTemplate().getForEntity("https://smartwater.user1.techolution.lab/consolidateddata/connections",MeterConnection[].class);
